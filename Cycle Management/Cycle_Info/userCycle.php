...
<html>
    ...
    <body>
        ...
        {
            $nid=$_POST['nid'];
            $_SESSION['nid_user'] = $nid;
        }
        else 
        {
            $nid = $_SESSION['nid_user'];
        }
        ...
        $sql = "Select * from cycle_owner natural join cycle_info natural join user where nid='$nid'";
        ...
        echo'
                    <div class="Heading">
                        <h2>Showing Cycles</h2>
                    </div>
                    <a class="btn  btn-primary btn-lg" href="searchUser.php">Back</a>
                    ';
        while ($res) {
            ...
            if (file_exists($filename)) {
                echo'
                    ...
                    <div class ="one">
                        ...
                        <div  class="two">
                            <p>Brand:  ' . $brand . '
                                <form action="cycleInfo3.php" method="POST" class="a">
